  ...
  return (
    <div className="home">
        ...
        <h1>POWER SOURCE: </h1>
          ...
          energy You can use yet, <br/>
          check power level left, <br/>
          click <a href="/status" id="home__link"><span>STATUS</span></a> to see KV.</p>
    ...
    <div className="home__section">
      <div className="home__article">
        ...
        <br/><br/>
        <strong>Power control</strong> is very important to not reamain with no energy, so check often how much energy your spaceship and lightsaber have energy to connect to the <strong> power source </strong> on time. Click each item to view its remaining power value.
      </div>
    </div>
      <footer>
